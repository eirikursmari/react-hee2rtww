...
const FILTER_OPTIONS = [
  ...
  { label: "Fields Engaged", key: "fields_engaged",
    tip: "The scholarly or artistic discourses the work substantively engages — not its topic or medium.",
    values: [
      "philosophy & phenomenology", "new materialism & posthumanism",
      "feminist & gender studies", "decolonial & postcolonial studies",
      "performance, theatre & dance", "sound & music studies",
      "visual & media studies", "literature & language",
      "pedagogy & education", "ecology & environmental humanities",
      "politics & activism", "science, technology & STS",
      "history & archival studies", "anthropology & ethnography",
      "health, body & medicine", "spirituality & contemplative traditions",
      "architecture, space & urbanism",
    ]},
...
const BREAKDOWN_DIMS = [
  ...
  { key: "fields_engaged",         label: "Fields engaged",         arr: true  },
