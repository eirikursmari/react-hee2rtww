...
const FILTER_OPTIONS = [
  ...
  { label: "Research Themes", key: "research_themes",
    tip: "The artistic-research concerns the work engages (its preoccupations, not its medium). Vocabulary derived from the peer-reviewed corpus by topic modelling.",
    values: [
      "sound, listening & the sonic", "voice & the vocal",
      "music & performance practice", "time, duration & repetition",
      "body, movement & embodiment", "place, landscape & site",
      "urban space, the public & the social", "ecology & the more-than-human",
      "material practice & making", "drawing, diagram & the graphic",
      "photography, image & the visual", "digital, computation & AI",
      "writing, language & translation", "memory & the archive",
      "indigenous, community & decolonial knowledge",
      "artistic-research method & pedagogy",
    ]},
  { label: "Relevance Reach", key: "relevance_reach",
    tip: "How far across disciplines the work reaches: mono-, cross-, or transdisciplinary.",
    values: ["mono-disciplinary", "cross-disciplinary", "transdisciplinary"]},
...
const BREAKDOWN_DIMS = [
  ...
  { key: "research_themes",        label: "Research themes",        arr: true  },
  { key: "relevance_reach",        label: "Relevance reach",        arr: true  },
...
export default function App() {
  ...
  function addAuroraSdgTemplate() {
    ...
    const tpl = {
      ...
      response: { array_path: "predictions", label_field: "sdg.name", score_field: "prediction", threshold: 0.2 },
